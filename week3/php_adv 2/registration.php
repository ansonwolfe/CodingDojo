...
// if all fields passed the registration test, store information in database, encrypt password, and redirect to wall.php
			if (!isset($_SESSION['error']))
			{
				...
				$query = "INSERT INTO users (first_name, last_name, username, email, password, created_at) VALUES ('{$_POST['first_name']}', '{$_POST['last_name']}', '{$_POST['username']}', '{$_POST['email']}', '{$password}', NOW())";
				mysql_query($query);
