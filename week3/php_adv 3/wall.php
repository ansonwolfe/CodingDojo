...
?>
				<div id="messages">	
					...
					<?php if ($_GET['id'] === $message['user_id']) {
						echo "<form id='delete_message' action='wall_process.php' method='post'>";
						echo "<input type='hidden' name='delete_message' value='" . $message['message_id'] . "'>";
						echo "<input id ='delete_message' class='pull-left' type='submit' value ='delete'>
						</form>";
					}?>
				</div>			
				<!-- comments  -->
